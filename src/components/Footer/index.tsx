...
export const Footer: FC = () => {
  ...
  const footerLinks = {
    products: {
      title: 'Products',
      links: [
        { href: '/products/lighting', label: 'Smart Lighting' },
        { href: '/products/security', label: 'Security Systems' },
        { href: '/products/climate', label: 'Climate Control' },
        { href: '/products/speakers', label: 'Smart Speakers' },
      ],
    },
    support: {
      title: 'Support',
